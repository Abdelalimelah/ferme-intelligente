  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editId) {
        ...
        await createUtilisateur({ ...form, role: 'AGRICULTEUR' });
        setModalOpen(false);
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {!editId && (
            <p className="text-xs text-stone bg-cream rounded-lg p-2.5">
              Un mot de passe temporaire sera envoyé automatiquement par email au nouvel utilisateur.
            </p>
          )}
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 p-4 bg-sage-mist/40 rounded-xl">
              ...
              <p className="text-sm text-charcoal">
                ...
                L'agriculteur devra changer son mot de passe à la première connexion.
              </p>
            </div>
